...
프로젝트에서 직접 작성·구성한 코드, 카페 주문 JSON, 메뉴 DB, 문서 및 발표용 도식은 `Copyright © 2026 최문희. All rights reserved.`로 고지한다. AI Hub 데이터, 기반 모델, 제3자 자료에는 각 제공자의 이용 조건이 적용된다. 상세한 범위는 [저작권 및 제3자 자료 고지](NOTICE.md)를 참고한다.
